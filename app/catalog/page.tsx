...
export default function CatalogPage() {
  return (
    <div style={{ paddingTop: '68px', minHeight: '100vh', background: '#ffffff' }}>
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: 'clamp(32px, 5vw, 64px) 1.5rem' }}>
        ...
        <p style={{ fontSize: '15px', color: '#666', marginBottom: '48px' }}>Complete overview of all modules, lessons, and resources</p>
